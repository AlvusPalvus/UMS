...
const Hero = ({ heroImage, heroContent }: HeroType) => {
    return (
        <div
            ...
            className="shadow-regular relative flex items-center justify-center bg-fixed bg-center h-screen sm:h-3/5"
        >
            {/* Overlay */}
            ...
            <div className="p-5 text-white z-[2] mt-[10rem] mb-[10rem]">
                <ReactMarkdown
                    className={"heroContent container buttonHome column"}
                >
                    {heroContent}
                </ReactMarkdown>
            </div>
